...
quotes: Quote[] = [
    ...
    new Quote(3,'Victoria','Shine your Face','Keep your face always toward the sunshine','and shadows will fall behind you',new Date(2021,1,12),0,0),
    ...
    new Quote(6,'Ann','All you want','You can be everything','You can be the infinite amount of things that people are.',new Date(2020,3,14),0,0),
  ];
  get sortQuotes() {
